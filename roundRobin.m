...
function [SuccTx, DL_time, UL_time, Ts] = roundRobin(MaxCycles, nSTAs, SS, P_rx, length, distance, SuccTx, opti)
...
for i = 1:MaxCycles % TxtoSTA_1 ... TxtoSTA_N-1 TxtoSTA_N || TxtoSTA_1 ... TxtoSTA_N-1 TxtoSTA_N
    ...
    for j = 1:nSTAs
        ...
        [DL_TxSTA(j), UL_TxSTA(j), prob_err] = wifiTransmissionTimeBasic(nSTAs, SS, P_rx(j), ... 
